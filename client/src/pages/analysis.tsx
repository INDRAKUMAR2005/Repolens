        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3 flex-wrap">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                disabled={!analysis?.downloadUrl}
                onClick={() => {
                  if (analysis?.downloadUrl) {
                    const link = document.createElement("a");
                    link.href = analysis.downloadUrl;
                    link.target = "_blank";
                    link.setAttribute("download", `${analysis.repoInfo.name}.zip`);
                    document.body.appendChild(link);
                    link.click();
                    document.body.removeChild(link);
                    toast({ title: "Downloading", description: "Your source code download is starting..." });
                  }
                }}
                data-testid="menu-download-zip"
              >
